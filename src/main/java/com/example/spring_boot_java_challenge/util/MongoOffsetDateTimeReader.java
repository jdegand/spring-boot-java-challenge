package com.example.spring_boot_java_challenge.util;

import static com.example.spring_boot_java_challenge.util.MongoOffsetDateTimeWriter.DATE_FIELD;
import static com.example.spring_boot_java_challenge.util.MongoOffsetDateTimeWriter.OFFSET_FIELD;
